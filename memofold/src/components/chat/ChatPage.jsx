...
const ChatPage = () => {
    ...
    const initChat = async () => {
        ...
        try {
            ...
            // Unlock on error so user can retry or component can retry
            ...
            if (!reloadAttemptedRef.current) {
                ...
                toast.error(
                    "Unable to initialize chat. Please reload the page manually."
                );
            }
        }
    };
    ...
    useEffect(() => {
        ...
        return () => {
            if (chatClient) {
                // Optional: Disconnect only if you want to close connection on unmount
                    ...
                    <div className="w-full h-full flex flex-col">
                        ...
                        <div className={`flex items-center justify-between px-4 border-b ${isDarkMode ? 'border-gray-700 bg-gray-900' : 'border-gray-200 bg-white'}`}>
                            <div className="flex items-center space-x-3">
                                ...
                                <div
                                    onClick={(e) =>
                                        navigateToUserProfile(targetUser?.id, e)
                                    }
