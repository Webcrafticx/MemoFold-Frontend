                ...
                <div className="max-w-4xl mx-auto bg-white/90 p-6 md:p-10 rounded-2xl shadow-xl my-8 backdrop-blur-sm">
                    ...
                    <section className="mt-12">
                        ...
                        <p className="text-gray-600 mb-3">
                            Whether you're a registered user or someone listed
                            in an uploaded contact list, we're here to support
                            your rights and respond to your concerns.
                        </p>
                        <p className="text-gray-600 mb-6">
                            Use the form below to delete uploaded data, opt out
                            as a non-user, or simply ask a question. Your voice
