...
const ProfilePage = () => {
  ...
  const initializeApp = () => {
    ...
    if (!localStorage.getItem("commentLikes")) {
      localStorage.setItem("commentLikes", JSON.stringify({}));
    }
  ...
  const fetchComments = async (postId) => {
    ...
    try {
      ...
      const commentsWithLikes = comments.map((comment) => {
        ...
        const hasUserLiked = commentLikes.includes(currentUserId);
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${darkMode ? "bg-gray-900 text-gray-100" : "text-gray-800"
        }`}
    >
      {/* Toast Container */}
      <ToastContainer
      ...
      {showMobileMenu && (
        ...
        >
          <div className="flex flex-col p-4 gap-3">
            ...
            <button
              onClick={() => setDarkMode(!darkMode)}
              className={`flex items-center gap-2 p-2 rounded-lg ${darkMode
      ...
      {/* Main Content */}
      <div
        className={`pt-4 sm:pt-6 pb-12 ${darkMode
          ? "bg-gray-900"
          : "bg-gradient-to-r from-gray-100 to-gray-300"
          }`}
      >
        {/* Profile Section */}
        <div
          className={`max-w-4xl mx-auto mb-6 sm:mb-8 ${darkMode
            ? "bg-gray-800 border-gray-700"
            : "bg-white border-gray-200"
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-4 sm:mb-6">
              ...
              >
                <div className="relative">
                  <img
                    src={profilePic}
                    alt="Profile"
                    className={`w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full border-4 border-blue-400 hover:scale-105 transition-transform ${uploadingProfilePic
                      ? "opacity-50"
                      : ""
                      }`}
                    onError={(e) => {
            ...
            <div className="flex-1 w-full">
                  ...
                  <div className="flex-1 flex flex-col sm:flex-row gap-2">
                    ...
                    <div className="flex gap-2 justify-center sm:justify-start">
                      <button
                        ...
                        className={`px-3 py-1 rounded-lg font-medium ${updatingBio
                          ? "bg-blue-400"
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mt-4 sm:mt-6 justify-center sm:justify-start">
                <div
                  className={`flex items-center gap-1 sm:gap-2 ${darkMode
                    ? "bg-gray-700 hover:bg-gray-600"
        ...
        {/* Create Post Section */}
        <div
          className={`max-w-2xl mx-auto mb-6 sm:mb-8 ${darkMode
            ? "bg-gray-800 border-gray-700"
            : "bg-white border-gray-200"
            ...
            <div className="space-y-4 sm:space-y-6 pb-4 sm:pb-6">
              {posts.map((post) => (
                ...
                >
                  ...
                  {/* Post Content */}
                  <p
                    className={`mb-3 sm:mb-4 ${darkMode
                      ? "text-gray-300"
                      : "text-gray-700"
                      ...
                      {isFetchingComments ? (
                        ...
                        <>
                          {post.comments &&
                            ...
                            <div
                              className={`mb-4 space-y-3 max-h-60 overflow-y-auto p-2 rounded-lg ${darkMode
                                ? "bg-gray-700"
                                : "bg-gray-100"
                                }`}
                            >
                                ...
                                <div key={comment._id} className="flex items-start space-x-2">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <div className="mt-1 flex items-center justify-between">
                                      <button
                                        className="flex items-center space-x-1 hover:text-red-500 transition-colors cursor-pointer text-xs"
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="flex-1 flex space-x-2">
                              <input
                                type="text"
                                className={`flex-1 px-3 py-2 rounded-full text-sm border ${darkMode
                              ...
                              />
                              <button
                                className={`px-3 py-1 rounded-full text-sm ${!commentContent[
                                  post._id
                                ]?.trim() ||
                                  isAddingComment
